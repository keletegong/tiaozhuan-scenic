...
function layer_alert(str) {
    layer.alert(str, {title: false});
}

function layer_alert_jump(str, redirect, sec) {
    layer.alert(str, {title: false, closeBtn: 0}, function () {
        sec = sec ? sec * 500 : 500;
        setTimeout(function () {
            if (redirect) {
...
function layer_msg_jump(str, redirect, sec) {
    sec = sec ? sec * 1000 : 1500;
    layer.msg(str, {time: sec}, function () {
        if (redirect) {
            location.href = redirect;
        } else {
            location.reload();
...
function layer_confirm(str, ok, cancel, func1, func2) {
    var ok_str = ok ? ok : '确定';
    var cancel_str = cancel ? cancel : '取消';
    layer.confirm(str, {
        btn: [ok_str, cancel_str],
        title: false,
        closeBtn: 0,
    }, function () {
        if (func1) {
